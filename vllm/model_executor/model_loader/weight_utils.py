...
def safetensors_weights_iterator(
    ...
    *,
    ...
    reduces storage I/O for MoE models under EP.  *skip_patterns* (compiled
    regexes) additionally defers matched weights out of this sweep so a
    dedicated second pass can load them (e.g. the Engram host tables).
    """
    ...
    for st_file in tqdm(
        ...
        if safetensors_load_strategy == "eager":
            ...
            for name, param in state_dict.items():
                if not should_skip_weight(name, local_expert_ids, skip_patterns):
                    yield name, param
            ...
            with safe_open(st_file, framework="pt") as f:
                ...
                for name in f.keys():  # noqa: SIM118
                    if should_skip_weight(name, local_expert_ids, skip_patterns):
                        continue
