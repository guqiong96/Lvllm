...
ChatCommand = auto_mock("vllm.entrypoints.cli.openai_entrypoint", "ChatCommand")
CompleteCommand = auto_mock("vllm.entrypoints.cli.openai_entrypoint", "CompleteCommand")
