...
[`patches/01_lk_moe__3116c5d.patch`](./patches/01_lk_moe__3116c5d.patch) — the full diff between
upstream base commit `3116c5d` and the lk_moe fork. Apply it to
a clean `3116c5d` checkout with `git apply patches/01_lk_moe__3116c5d.patch`.
...
The portable patch `patches/01_lk_moe__3116c5d.patch` is generated by diffing the current tree against
the upstream base commit `3116c5d` (the local `3116c5d` commit, no network needed). **Note: the patch only contains the
...
Apply it on a clean upstream `3116c5d` checkout:
