#!/usr/bin/env bash
# Qwen3.6-35B-A3B-W4A16-NVFP4 · 4 GPUs (2x3090 + 2x5060Ti), TP4, MTP3 speculative decode.
...
vllm serve /home/guqiong/Models/Qwen3.6-35B-A3B-W4A16-NVFP4 \
    --host 0.0.0.0 \
    --port 8070 \
    ...
    --trust-remote-code \
    --tokenizer-mode auto \
    --served-model-name Qwen3.6-35B-A3B-W4A16-NVFP4 \
